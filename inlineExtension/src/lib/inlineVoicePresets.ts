...
// Order matters: the first entry is the default. "Premade" voices below work
// on every ElevenLabs tier (including free). The "professional" voices at the
// bottom require a paid subscription (free tier returns 402 paid_plan_required).
