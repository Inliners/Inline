...
const SOLUTIONS = [
  ...
  { icon: MessageSquareText, label: 'Ask AI over your own captures',   detail: 'Semantic retrieval finds the right notes and documents, and every answer points back to its sources.' },
